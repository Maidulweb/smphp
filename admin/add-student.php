...
require_once('db.php');
 if(isset($_POST['add_student'])){
  ...
  $student_photo = $student_roll . '.' .$photo;
   ...
   $query = "SELECT * from add_student where student_roll='$student_roll'";
  ...
  $sql = "INSERT INTO add_student(student_name,student_roll,student_photo)VALUES('$student_name', '$student_roll', '$student_photo')";
